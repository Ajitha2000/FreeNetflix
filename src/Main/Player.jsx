...
export default function Player(){
    ...
    const firebaseConfig = {
        apiKey: "AIzaSyChexQwafb1eJufGA-6Ar0PgPP7IjRFu5s",
        authDomain: "ajitha-9cf43.firebaseapp.com",
        projectId: "ajitha-9cf43"
    };
    ...
    return(
        ...
        <div className="share">
            ...
            <CopyToClipboard text="https://github.com/ajibegam/Free-Netflix" onCopy={oncopy}>
